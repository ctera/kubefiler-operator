...
func (r ApiLoginPostRequest) Execute() (string, *_nethttp.Response, error) {
	return r.ApiService.LoginPostExecute(r)
}

/*
 * LoginPost Get JWT from User/Password
...
func (a *LoginApiService) LogoutPostExecute(r ApiLogoutPostRequest) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LoginApiService.LogoutPost")
	if err != nil {
